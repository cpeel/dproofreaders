...
$login_failures = [
    ...
    'banned' => sprintf(_("Your account has been banned. If you feel this is in error, please contact a <a href='%s'>site manager</a>."), "mailto:" . SiteConfig::$site_manager_email_addr),
    'unknown_failure' => sprintf(_("An unexpected failure occurred, please contact a <a href='%s'>site manager</a>."), "mailto:" . SiteConfig::$site_manager_email_addr),
    ...
    'reg_mismatch' => sprintf(_("You are registered with the forum software, but not with %s."), SiteConfig::$site_abbreviation),
