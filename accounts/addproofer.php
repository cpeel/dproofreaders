...
if (SiteConfig::$site_registration_protection_code) {
    include_once(SiteConfig::$site_registration_protection_code);
...
echo sprintf(_("Thank you for your interest in %s. To create an account, please complete the form below."), SiteConfig::$site_name);
...
echo "<li>" . sprintf(_("Please ensure that the e-mail address you provide is correct. %s will e-mail a confirmation link for you to follow in order to activate your account."), SiteConfig::$site_name) . "</li>";
echo "<li>" . sprintf(_("<strong>Before</strong> you submit this form, please add <i>%s</i> to your e-mail contacts list to avoid the activation e-mail being treated as spam."), SiteConfig::$general_help_email_addr) . "</li>";
echo "</ul>";
