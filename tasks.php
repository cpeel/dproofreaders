...
$tasks_url = SiteConfig::$code_url . "/" . basename(__FILE__);
...
function create_task_from_form_submission(array $formsub): ?string
{
    ...
    if ($newt_assignee != 0) {
        ...
        send_mail(
            ...
            SiteConfig::$site_abbreviation . " Task Center: Task #$task_id has been assigned to you",
...
function TaskHeader(string $header, bool $show_new_alert = false): void
{
    ...
    $header_args = ["js_files" => [SiteConfig::$code_url . "/scripts/tasks.js"]];
...
function NotificationMail($tid, $message, $new_task = false)
{
    ...
    $subject = SiteConfig::$site_abbreviation . " Task #$tid: $task_summary";
