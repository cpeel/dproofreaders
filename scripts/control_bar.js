...
export function makeControlDiv(container, content, controls) {
    ...
    const rightButton = $("<button>", { class: "navbutton", title: translate.gettext("Right-align controls") }).append($("<i>", { class: "fas fa-caret-right" }));
    ...
    const westButton = $("<button>", { class: "navbutton", title: translate.gettext("Dock control bar to left") }).append($("<i>", { class: "fas fa-arrow-left" }));
    const northButton = $("<button>", { class: "navbutton", title: translate.gettext("Dock control bar to top") }).append($("<i>", { class: "fas fa-arrow-up" }));
    const southButton = $("<button>", { class: "navbutton", title: translate.gettext("Dock control bar to bottom") }).append($("<i>", { class: "fas fa-arrow-down" }));
    const eastButton = $("<button>", { class: "navbutton", title: translate.gettext("Dock control bar to right") }).append($("<i>", { class: "fas fa-arrow-right" }));
