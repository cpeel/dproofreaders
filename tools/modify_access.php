...
function notify_user($user, $actions)
{
    if ((count($actions) == 1) && (array_search('grant', $actions) !== false)) {
        ...
        $subject = SiteConfig::$site_abbreviation . ": You have been granted access to $activity_id!";
        ...
        $message .= sprintf(_("Thank you for volunteering with %s!"), SiteConfig::$site_name);
        ...
        $subject = SiteConfig::$site_abbreviation . ": Your access has been modified";
        $message = "Hello $user->username,\n\n" .
