...
if ($action == 'update_oneshot') {
    if (isset($_REQUEST['edit'])) {
        ...
        if ($source->code_name && !isset($_REQUEST['editing'])) {
            ...
            Otherwise, choose a different ID for this source.'), SiteConfig::$db_requests_email_addr) . "<br>";
        }
...
class ImageSource
{
    ...
    public function _show_edit_permissions_row()
    {
        ...
        foreach ([
            ...
            '2' => sprintf(_("All %s Users"), SiteConfig::$site_abbreviation),
    ...
    public function approve()
    {
        ...
        foreach ($notify_users as $username) {
            ...
            $subject = sprintf(_('%1$s: Image Source %2$s has been approved!'), SiteConfig::$site_abbreviation, $this->display_name);
    ...
    public function _showto($show_to)
    {
        switch ($show_to) {
            ...
            case '1':
                ...
                break;
            case '2':
                $to_whom = sprintf(_("Any %s User"), SiteConfig::$site_abbreviation);
                break;
            case '3':
    ...
    public function log_request_for_approval($requestor_username)
    {
        ...
        $subject = sprintf(_('%s: New Image Source proposed'), SiteConfig::$site_abbreviation)." : ".$this->display_name;
        ...
        $body = sprintf(
            ...
            SiteConfig::$general_help_email_addr,
            $requestor_username,
            $this->display_name,
            SiteConfig::$code_url,
            $this->code_name
        ...
        send_mail(SiteConfig::$image_sources_manager_addr, $subject, $body);
    }
}
