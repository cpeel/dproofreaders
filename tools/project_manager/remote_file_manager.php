...
$uploads_dir = SiteConfig::$uploads_dir;

// Directory structure under uploads dir
$trash_rel_dir = SiteConfig::$uploads_subdir_trash;
$trash_dir = "$uploads_dir/$trash_rel_dir";

$commons_rel_dir = SiteConfig::$uploads_subdir_commons;
$commons_dir = "$uploads_dir/$commons_rel_dir";

$users_rel_dir = SiteConfig::$uploads_subdir_users;
...
if (is_null($home_dirname)) {
    $db_requests_email_addr = SiteConfig::$db_requests_email_addr;
