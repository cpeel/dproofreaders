...
$quiz_type_intro = [
    "proof" => [
        ...
        "head" => "<h1>" . _("Interactive Proofreading Quizzes and Tutorials") . "</h1>\n" .
                  "<p>" . sprintf(_("Welcome to %s's interactive proofreading quizzes and tutorials! These quizzes cover corrections you should make in the proofreading rounds."), SiteConfig::$site_abbreviation) . "</p>\n" .
...
// otherwise just give links to P and F quizzes separately, so that the page isn't too long
    ...
    echo "<p>" . sprintf(_("Welcome to %s's interactive quizzes! The following quizzes are available:"), SiteConfig::$site_abbreviation) . "</p>\n<p>";
