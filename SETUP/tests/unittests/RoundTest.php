...
class ActivityTest extends PHPUnit\Framework\TestCase
{
    ...
    public function test_project_state_functions(): void
    {
        ...
        $this->assertEquals(SiteConfig::$waiting_projects_forum_idx, ProjectStates::get_forum(PROJ_P1_WAITING_FOR_RELEASE));
        $this->assertEquals(SiteConfig::$projects_forum_idx, ProjectStates::get_forum(PROJ_P2_WAITING_FOR_RELEASE));
        $this->assertEquals(SiteConfig::$pp_projects_forum_idx, ProjectStates::get_forum(PROJ_POST_FIRST_AVAILABLE));
