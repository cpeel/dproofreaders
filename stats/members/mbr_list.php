...
echo "<th style='text-align: center;'><a href='mbr_list.php?uname=" . attr_safe($uname) . "&amp;mstart=$mstart&amp;order=date_created&amp;direction=$newdirection'>".sprintf(_("Date Joined %s"), SiteConfig::$site_abbreviation)."</a></th>";
